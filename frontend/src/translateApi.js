...
const MESSAGE_CODE = {
  ...
  'Cannot approve: employee has no check-in on the requested date.': 'CHECK_IN_REQUIRED',
  'A pending backdate request already exists for this delivery.': 'BACKDATE_PENDING',
  'Requested date must be before today.': 'DATE_NOT_PAST',
  'Backdate cannot be more than 7 days ago.': 'DATE_TOO_OLD',
  'Requested date matches the current delivery date.': 'DATE_UNCHANGED',
  'Invalid requested date.': 'INVALID_DATE',
