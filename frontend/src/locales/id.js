export default {
  ...
  logout: 'Keluar',
  language: 'Bahasa',
  uiShowSection: 'Tampilkan detail',
  uiHideSection: 'Sembunyikan detail',
  english: 'Inggris',
  ...
  employeeStatusInactive: 'Nonaktif',
  employeeStatusLabel: 'Status karyawan',
  employeeStatusHint: 'Karyawan nonaktif tidak masuk slip gaji dan tidak bisa login.',
  ...
  payrollProcessMonth: 'Proses bulan ini',
  payrollProcessMonthHint:
    'Tarik kehadiran, kasbon, dan bonus lapangan ke baris gaji. Jalankan ini dulu setiap bulan.',
  payrollWorkflowTitle: 'Gaji bulanan',
  payrollWorkflowStepMonth: 'Pilih bulan',
  payrollWorkflowStepGenerate: 'Proses dari kehadiran',
  payrollWorkflowStepReview: 'Perbaiki pengecualian',
  payrollWorkflowStepExport: 'Ekspor slip',
  payrollSearchPlaceholder: 'Cari nama atau ID karyawan…',
  payrollFilterAll: 'Semua karyawan',
  payrollFilterAttention: 'Perlu dicek',
  payrollNoMatches: 'Tidak ada karyawan yang cocok dengan filter ini.',
  payrollAttentionCount: '{{count}} perlu dicek',
  payrollEditRowAction: 'Ubah',
  payrollAdvancedSettings: 'Default tunjangan',
  payrollShowAdvancedSettings: 'Tampilkan default tunjangan',
  payrollHideAdvancedSettings: 'Sembunyikan default tunjangan',
  payrollAdvancedDeductions: 'Pajak dan BPJS',
  payrollLemburAutoHint: 'Dihitung otomatis untuk staf kantor dan accounting dari kehadiran.',
  payrollGenerateHint:
  ...
  payrollDefaultUpahHarian: 'Default upah harian — Petugas Lapangan & Urusan Umum (Rp)',
  payrollDefaultUpahHarianHint:
    'Petugas lapangan dan Urusan Umum. Dipakai bila karyawan belum punya upah di profil.',
  payrollSaveSettings: 'Simpan default',
  payrollSettingsSaved: 'Nominal default disimpan.',
  payrollEmployeeTable: 'Gaji karyawan',
  ...
  payrollLoanDeductionHint: 'Otomatis dari pinjaman yang disetujui dan berlaku untuk bulan ini.',
  payrollActiveLoanHint:
    '{{count}} pinjaman aktif — {{monthly}}/bln · total sisa Rp {{remaining}}',
  ...
  payrollTunjanganPph21: 'Tunjangan PPh 21',
  ...
  payrollEarlyLeaveDeduction: 'Potongan pulang awal',
  ...
  payrollLateDeductionHint:
    'Otomatis dari menit terlambat (tarif per menit sama dengan lembur). Staff Kantor dan Accounting.',
  payrollEarlyLeaveDeductionHint:
    'Staff Kantor: otomatis dari menit pulang awal (tarif per menit sama dengan lembur). Peran lain: isi manual bila perlu.',
  ...
  pabrikLocationHint: 'Link peta pabrik berasal dari lokasi yang Anda kelola di tab ini.',
  ...
  pabrikRadiusHint: 'Radius absen untuk pabrik ini. Kosongkan untuk memakai default.',
  ...
  pabrikTonaseExportHint:
    'Ekspor total bonus pengiriman per pabrik dan kode barang (berat bersih + bonus) untuk rentang tanggal. Lebih baik tinjau di laporan pabrik/barang di atas sebelum cetak.',
  pabrikTonaseDateFrom: 'Dari tanggal',
  pabrikTonaseDateTo: 'Sampai tanggal',
  pabrikTonaseDownload: 'Unduh Excel',
  pabrikTonaseExported: 'Laporan bonus omset diunduh.',
  ...
  loanTitle: 'Pinjaman',
  loanEmployeeHint:
    'Ajukan satu atau lebih pinjaman, pilih bulan mulai pelunasan, dan tentukan potong gaji per bulan untuk setiap pinjaman.',
  loanAdminTitle: 'Pinjaman',
  loanAdminSubtitle: 'Tinjau dan setujui pengajuan pinjaman karyawan.',
  loanAdminHint:
    'Pinjaman yang disetujui memakai potong gaji bulanan sesuai pengajuan karyawan mulai pada bulan yang dipilih.',
  ...
  loanStartMonth: 'Bulan mulai pelunasan',
  loanStartMonthHint: 'Potongan dimulai pada periode gaji yang dipilih.',
  loanRepaymentStarts: 'Pelunasan dimulai',
  loanStartImmediately: 'Langsung (pinjaman lama)',
  ...
  loanProgressPending: 'Menunggu persetujuan admin. Pelunasan dijadwalkan mulai pada {{month}}.',
  ...
  roleGeneralAffairs: 'Urusan Umum',
  roleHeadOfFinance: 'Head of Finance',
  roleAdmin: 'Admin',
  headOfFinanceNoAttendance: 'Pusat keuangan — tinjau omset lapangan dan slip gaji Anda.',
  headOfFinanceHubTitle: 'Keuangan',
  headOfFinanceReviewOmset: 'Tinjau omset lapangan',
  headOfFinanceReviewOmsetHint: 'Cek kode pengiriman dan bonus sebelum gaji difinalkan.',
  headOfFinancePayrollSummary: 'Ringkasan gaji',
  headOfFinancePayrollSummaryHint: 'Total hanya-baca untuk bulan terpilih (admin memproses gaji).',
  headOfFinancePayrollEmpty: 'Belum ada gaji untuk bulan ini.',
  ...
  officeRequiredEmployee: 'Pilih kantor untuk Staff Kantor, Petugas Lapangan, atau Cleaning.',
  ...
  fieldMyRecapTitle: 'Rekap pengiriman saya',
  fieldMyRecapHint:
    'Per pabrik dan kode barang untuk bulan gaji yang dipilih (tgl 25 bulan sebelumnya – tgl 24): berat bersih dan bonus. Bonus sama dengan slip gaji.',
  fieldMyRecapBonusTotal: 'Total bonus bulan ini',
  fieldMyRecapBonusHint: '{{count}} baris pengiriman · bonus = omset × tarif pabrik',
  fieldMyRecapEmpty: 'Belum ada pengiriman di bulan gaji ini.',
  fieldMyRecapItem: 'Barang',
  fieldMyRecapDeliveries: 'Pengiriman',
  fieldMyRecapBonusCol: 'Bonus',
  fieldMyRecapFactorySubtotal: '{{kg}} kg · bonus Rp {{bonus}}',
  fieldFactoryBonusReportTitle: 'Laporan bonus per pabrik / barang',
  fieldFactoryBonusReportHint:
    'Berat bersih dan bonus petugas lapangan digabung per pabrik dan kode barang. Filter satu pabrik, lalu unduh Excel untuk dicetak.',
  fieldFactoryBonusFilterPabrik: 'Pabrik',
  fieldFactoryBonusDownload: 'Unduh Excel',
  fieldFactoryBonusExported: 'Laporan bonus pabrik/barang diunduh.',
  fieldFactoryBonusNetTotal: 'Total berat bersih',
  fieldFactoryBonusNetHint: 'Jumlah berat bersih dalam rentang',
  fieldFactoryBonusEmpty: 'Belum ada pengiriman di rentang tanggal ini.',
  fieldFactoryBonusFilterNoMatch: 'Tidak ada baris yang cocok dengan pabrik yang dipilih.',
  ...
  fieldDeliveryRecapFilterClear: 'Hapus filter',
  fieldDeliveryRecapFilterCount: '{{shown}} dari {{total}} baris',
  ...
  fieldDeliveryRecapReviewSaved: 'Cek tersimpan.',
  fieldDeliveryRecapReviewLastSaved:
    'Terakhir dicek oleh {{name}} pada {{date}} — {{verdict}}',
  fieldDeliveryRecapReviewNotesLabel: 'Apa yang salah?',
  fieldDeliveryRecapReviewNotesPlaceholder: 'Jelaskan apa yang tidak benar…',
  fieldDeliveryRecapReviewNotesRequired: 'Isi catatan jika rekap tidak benar.',
  fieldDeliveryRecapReviewVerdictRequired: 'Pilih benar atau tidak benar.',
  ...
  fieldBackdateRequest: 'Ajukan ubah tanggal',
  fieldBackdateHint:
    'Minta admin memindahkan pengiriman ke hari sebelumnya (maks. 7 hari). Anda harus sudah absen masuk pada tanggal tersebut.',
  fieldBackdateDate: 'Tanggal pengiriman',
  fieldBackdateReason: 'Alasan',
  fieldBackdateSubmit: 'Kirim pengajuan',
  fieldBackdateSubmitted: 'Pengajuan ubah tanggal terkirim.',
  fieldBackdatePending: 'Ubah tanggal menunggu',
  fieldBackdateNeedFields: 'Pilih tanggal dan isi alasan.',
  fieldBackdateAdminTitle: 'Ubah tanggal pengiriman',
  fieldBackdateAdminHint:
    'Setujui hanya jika petugas absen masuk pada tanggal yang diminta. Bonus tetap sesuai yang tercatat.',
  fieldBackdateNoPending: 'Tidak ada pengajuan ubah tanggal yang menunggu.',
  fieldBackdateApproved: 'Ubah tanggal disetujui.',
  fieldBackdateRejected: 'Ubah tanggal ditolak.',
  fieldBackdateFrom: 'Tanggal saat ini',
  fieldBackdateTo: 'Tanggal diminta',
  ...
  loading: 'Memuat…',
  submitting: 'Mengirim…',
  correctionRequest: 'Ajukan koreksi',
  correctionCancel: 'Batal',
  correctionSubmit: 'Kirim koreksi',
  correctionSubmitted: 'Pengajuan koreksi terkirim.',
  correctionPending: 'Koreksi menunggu persetujuan',
  correctionReason: 'Alasan',
  correctionAdminTitle: 'Koreksi kehadiran',
  correctionAdminSubtitle: 'Tinjau dan setujui pengajuan koreksi waktu karyawan.',
  correctionPendingTitle: 'Koreksi menunggu',
  correctionPendingHint: 'Koreksi yang disetujui memperbarui waktu kehadiran secara otomatis.',
  correctionNoPending: 'Tidak ada pengajuan koreksi yang menunggu.',
  correctionApproved: 'Koreksi disetujui.',
  correctionRejected: 'Koreksi ditolak.',
  correctionRequestedCheckIn: 'Absen masuk diminta',
  correctionRequestedCheckOut: 'Absen keluar diminta',
  correctionSubmittedAt: 'Diajukan',
  reportsTitle: 'Laporan',
  reportsSubtitle: 'Analitik, jejak audit, dan aktivitas API.',
  reportsTab_analytics: 'Analitik',
  reportsTab_audit: 'Log audit',
  reportsTab_activity: 'Log aktivitas',
  reportsMonthlyAttendance: 'Kehadiran bulanan per status',
  reportsDepartmentAttendance: 'Kehadiran per departemen',
  reportsOvertimeTrends: 'Tren lembur',
  reportsPayrollTrends: 'Total gaji per periode',
  reportsAuditLogs: 'Log audit keamanan',
  reportsActivityLogs: 'Log aktivitas HTTP',
  reportsYear: 'Tahun',
  reportsMonth: 'Bulan',
  reportsRefresh: 'Muat ulang',
  reportsNoData: 'Belum ada data untuk periode ini.',
  reportsSearchDepartment: 'Cari departemen',
  reportsSortBy: 'Urutkan',
  reportsSortDepartment: 'Departemen',
  reportsSortRecords: 'Catatan',
  reportsSortHours: 'Jam kerja',
  reportsDeptRecords: '{{count}} catatan',
  reportsNoMatch: 'Tidak ada departemen yang cocok.',
  ...
  api: {
    ...
    ACCOUNT_INACTIVE: 'Akun nonaktif. Hubungi administrator.',
    REVIEW_VERDICT: 'Pilih benar atau tidak benar.',
    REVIEW_NOTES: 'Isi catatan jika rekap tidak benar.',
    ...
    BACKDATE_PENDING: 'Sudah ada pengajuan ubah tanggal untuk pengiriman ini.',
    DATE_NOT_PAST: 'Tanggal yang diminta harus sebelum hari ini.',
    DATE_TOO_OLD: 'Ubah tanggal tidak boleh lebih dari 7 hari yang lalu.',
    DATE_UNCHANGED: 'Tanggal yang diminta sama dengan tanggal pengiriman saat ini.',
    ...
    LOAN_START_PERIOD: 'Pilih bulan mulai pelunasan yang valid.',
    ...
    CORRECTION_PENDING: 'Sudah ada pengajuan koreksi yang menunggu untuk catatan kehadiran ini.',
