export default {
  ...
  fieldDeliveryRecapChecklistTitle: 'Checklist review',
  fieldDeliveryRecapChecklistHint: 'Tambah item verifikasi, centang, lalu simpan untuk mencatat akun yang mengecek rekap ini.',
  fieldDeliveryRecapChecklistAdd: 'Tambah item',
  fieldDeliveryRecapChecklistPlaceholder: 'Item checklist…',
  fieldDeliveryRecapChecklistSave: 'Simpan review',
  fieldDeliveryRecapChecklistSaved: 'Review tersimpan.',
  fieldDeliveryRecapChecklistLastReview: 'Terakhir dicek oleh {{name}} pada {{date}}',
  fieldDeliveryRecapChecklistEmpty: 'Tambahkan minimal satu item checklist sebelum menyimpan.',
