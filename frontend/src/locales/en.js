export default {
  ...
  pabrikCatalogHint:
    'Factories and item codes from your reference table are pre-loaded on deploy. Each factory is tied to a location from Location management — map links come from there.',
  ...
  pabrikLocationHint: 'Factory map links come from locations you manage on the admin dashboard.',
