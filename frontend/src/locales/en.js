export default {
  ...
  fieldDeliveryRecapChecklistTitle: 'Review checklist',
  fieldDeliveryRecapChecklistHint: 'Add verification items, mark them, then save to record who checked this recap.',
  fieldDeliveryRecapChecklistAdd: 'Add item',
  fieldDeliveryRecapChecklistPlaceholder: 'Checklist item…',
  fieldDeliveryRecapChecklistSave: 'Save review',
  fieldDeliveryRecapChecklistSaved: 'Review saved.',
  fieldDeliveryRecapChecklistLastReview: 'Last checked by {{name}} on {{date}}',
  fieldDeliveryRecapChecklistEmpty: 'Add at least one checklist item before saving.',
