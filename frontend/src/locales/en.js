export default {
  ...
  logout: 'Logout',
  language: 'Language',
  uiShowSection: 'Show details',
  uiHideSection: 'Hide details',
  english: 'English',
  ...
  employeeStatusHint: 'Inactive employees are excluded from payroll and cannot log in.',
  ...
  payrollProcessMonth: 'Process this month',
  payrollProcessMonthHint:
    'Pulls attendance, loans, and field bonuses into payroll rows. Run this first each month.',
  payrollWorkflowTitle: 'Monthly payroll',
  payrollWorkflowStepMonth: 'Choose month',
  payrollWorkflowStepGenerate: 'Process from attendance',
  payrollWorkflowStepReview: 'Fix exceptions',
  payrollWorkflowStepExport: 'Export slips',
  payrollSearchPlaceholder: 'Search name or employee ID…',
  payrollFilterAll: 'All employees',
  payrollFilterAttention: 'Needs review',
  payrollNoMatches: 'No employees match this filter.',
  payrollAttentionCount: '{{count}} to review',
  payrollEditRowAction: 'Edit',
  payrollAdvancedSettings: 'Allowance defaults',
  payrollShowAdvancedSettings: 'Show allowance defaults',
  payrollHideAdvancedSettings: 'Hide allowance defaults',
  payrollAdvancedDeductions: 'Tax and statutory (BPJS, PPh)',
  payrollLemburAutoHint: 'Auto-calculated for office staff and accounting from attendance.',
  payrollGenerateHint:
  ...
  payrollDefaultUpahHarian: 'Default daily wage — Field officers & General Affairs (IDR)',
  payrollDefaultUpahHarianHint:
    'Petugas lapangan and General Affairs. Used when the employee has no daily wage on their profile yet.',
  ...
  payrollLoanDeductionHint: 'Auto-applied from approved loans eligible for this month.',
  payrollActiveLoanHint:
    '{{count}} active loan(s) — {{monthly}}/mo · combined remaining Rp {{remaining}}',
  ...
  payrollTunjanganPph21: 'PPh 21 allowance',
  ...
  payrollLateDeductionHint:
    'Auto from late check-in minutes (same per-minute rate as overtime). Staff Kantor and Accounting.',
  payrollEarlyLeaveDeductionHint:
    'Staff Kantor: auto from early-leave minutes (same per-minute rate as overtime). Other roles: enter manually if needed.',
  ...
  pabrikTonaseExportHint:
    'Export delivery bonus totals per factory and item (net weight + bonus) for any date range. Prefer the factory/item report above for on-screen review before print.',
  pabrikTonaseDateFrom: 'From date',
  pabrikTonaseDateTo: 'To date',
  pabrikTonaseDownload: 'Download Excel',
  pabrikTonaseExported: 'Omset bonus report downloaded.',
  ...
  loanEmployeeHint:
    'Request one or more loans, choose when repayment starts, and specify the monthly salary deduction for each.',
  loanAdminTitle: 'Loans',
  loanAdminSubtitle: 'Review and approve employee loan requests.',
  loanAdminHint:
    'Approved loans use the employee’s proposed monthly salary deduction from the selected repayment month.',
  ...
  loanStartMonth: 'Repayment start month',
  loanStartMonthHint: 'Deductions begin in the selected payroll cycle.',
  loanRepaymentStarts: 'Repayment starts',
  loanStartImmediately: 'Immediate (legacy loan)',
  ...
  loanProgressPending: 'Waiting for admin approval. Repayment is scheduled to start in {{month}}.',
  ...
  roleAdmin: 'Admin',
  headOfFinanceNoAttendance: 'Finance hub — review field omset and your payslips.',
  headOfFinanceHubTitle: 'Finance',
  headOfFinanceReviewOmset: 'Review field omset',
  headOfFinanceReviewOmsetHint: 'Check delivery codes and bonuses before payroll is finalized.',
  headOfFinancePayrollSummary: 'Payroll snapshot',
  headOfFinancePayrollSummaryHint: 'Read-only totals for the selected month (admin processes payroll).',
  headOfFinancePayrollEmpty: 'No payroll generated for this month yet.',
  ...
  officeRequiredEmployee: 'Select an office for Staff Kantor, Petugas Lapangan, or Cleaning.',
  ...
  fieldMyRecapTitle: 'My delivery recap',
  fieldMyRecapHint:
    'Per factory and item for the selected payroll month (25th previous – 24th): net weight and bonus. Bonus matches payroll.',
  fieldMyRecapBonusTotal: 'Bonus this month',
  fieldMyRecapBonusHint: '{{count}} delivery lines · bonus = omset × factory rate',
  fieldMyRecapEmpty: 'No deliveries in this payroll month yet.',
  fieldMyRecapItem: 'Item',
  fieldMyRecapDeliveries: 'Deliveries',
  fieldMyRecapBonusCol: 'Bonus',
  fieldMyRecapFactorySubtotal: '{{kg}} kg · bonus Rp {{bonus}}',
  fieldFactoryBonusReportTitle: 'Factory / item bonus report',
  fieldFactoryBonusReportHint:
    'Net weight and field-officer bonus rolled up per factory and item. Filter one factory, then download Excel to print.',
  fieldFactoryBonusFilterPabrik: 'Factory',
  fieldFactoryBonusDownload: 'Download Excel',
  fieldFactoryBonusExported: 'Factory/item bonus report downloaded.',
  fieldFactoryBonusNetTotal: 'Net weight total',
  fieldFactoryBonusNetHint: 'Sum of berat bersih in range',
  fieldFactoryBonusEmpty: 'No deliveries in this date range.',
  fieldFactoryBonusFilterNoMatch: 'No rows match the selected factory.',
  ...
  fieldDeliveryHint:
    'Full delivery data from all petugas lapangan — view only.',
  ...
  fieldDeliveryRecapFilterClear: 'Clear filters',
  fieldDeliveryRecapFilterCount: '{{shown}} of {{total}} lines',
  ...
  fieldDeliveryRecapReviewSaved: 'Check saved.',
  fieldDeliveryRecapReviewLastSaved:
    'Last checked by {{name}} on {{date}} — {{verdict}}',
  fieldDeliveryRecapReviewNotesLabel: 'What is wrong?',
  fieldDeliveryRecapReviewNotesPlaceholder: 'Describe what is incorrect…',
  fieldDeliveryRecapReviewNotesRequired: 'Add a note when the recap is not correct.',
  fieldDeliveryRecapReviewVerdictRequired: 'Mark the recap as correct or not correct.',
  ...
  fieldBackdateRequest: 'Request backdate',
  fieldBackdateHint:
    'Ask admin to move this delivery to a past day (max 7 days). You must have checked in on that day.',
  fieldBackdateDate: 'Delivery date',
  fieldBackdateReason: 'Reason',
  fieldBackdateSubmit: 'Submit request',
  fieldBackdateSubmitted: 'Backdate request submitted.',
  fieldBackdatePending: 'Backdate pending',
  fieldBackdateNeedFields: 'Choose a date and enter a reason.',
  fieldBackdateAdminTitle: 'Delivery backdates',
  fieldBackdateAdminHint:
    'Approve only when the officer checked in on the requested date. Bonus stays as recorded.',
  fieldBackdateNoPending: 'No pending delivery backdate requests.',
  fieldBackdateApproved: 'Backdate approved.',
  fieldBackdateRejected: 'Backdate rejected.',
  fieldBackdateFrom: 'Current date',
  fieldBackdateTo: 'Requested date',
  ...
  api: {
    ...
    REVIEW_VERDICT: 'Mark the recap as correct or not correct.',
    REVIEW_NOTES: 'Add a note when the recap is not correct.',
    ...
    BACKDATE_PENDING: 'A backdate request is already pending for this delivery.',
    DATE_NOT_PAST: 'Requested date must be before today.',
    DATE_TOO_OLD: 'Backdate cannot be more than 7 days ago.',
    DATE_UNCHANGED: 'Requested date matches the current delivery date.',
    INVALID_DATE: 'Invalid requested date.',
    ...
    LOAN_START_PERIOD: 'Choose a valid repayment start month.',
