...
export const paths = {
  ...
  adminFieldDeliveriesIncorrectCount: '/v1/admin/field-deliveries/incorrect-count',
  ...
  employeeFieldDeliveriesUncheckedCount: '/v1/employee/field-deliveries/unchecked-count',
